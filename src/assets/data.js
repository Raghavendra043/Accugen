// implant solutions
import AllZir from '../assets/images/products/implant/AllZir.png'
import Implant_Crowns_Bridges from '../assets/images/products/implant/Implant_Crowns_Bridges.png'
import Malo_Framework  from '../assets/images/products/implant/Malo_Framework.png'
...
// tooth solutions 
import Crowns  from '../assets/images/products/tooth/Crowns.png'
import Veneers  from '../assets/images/products/tooth/Veneers.png'
...
export const Sampledata = [
  {
    ...
    "tag":"CAD/CAM Milled with Grade 5 rematitan® Titanium",
  ...
  },
  {
    ...
    sub: "All-on-X Screw-Retained",
    h: "FULL ARCH IMPLANT PROTHESIS",
    tag : "ceraMotion® Z Zirconia Full Arch",
    img: AllZir,
  ...
  },
  {
    "code": "V-IPS",
      ...
      sub: "Veneers",
      h: "",
      "tag":"made with IPS e.max",
      "title": "ACCUGEN™ Milled Veneers",
      "description": "The ACCUGEN™ Milled (IPS e.max® CAD) Veneer is a premium, high-strength lithium disilicate veneer crafted with advanced CAD/CAM precision milling technology. Designed for superior esthetics, these veneers offer natural translucency, opalescence, and long-term durability, making them an ideal choice for minimally invasive smile transformations.Unlike conventional hand-layered ceramics that are prone to chipping, IPS e.max® CAD LT veneers are monolithic, ensuring enhanced strength (up to 530 MPa) and long-lasting performance. With ultra-thin design capabilities, they allow for minimal tooth preparation while delivering lifelike esthetics with seamless integration.",
      
      "specs": [
        { "title": "Material", "des": "IPS e.max® CAD LT " },
        { "title": "Flexural Strength", "des": "530 MPa" },
        { "title": "Available Shades", "des": "Available in multiple VITA® shade matches for natural esthetics" },
        { "title": "Translucency", "des": "44% – 47%" },
        { "title": "Additional Options", "des": ["Crystallization"] }
      ]
  },
]
